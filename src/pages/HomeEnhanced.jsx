    ...
    <div className="relative overflow-hidden">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          {/* Scroll Indicator - Hidden to avoid overlap with buttons */}
        ...
        >
          <FeaturesGrid 
            features={features.map(feature => ({
              title: language === 'vi' ? (feature.title_vi || feature.title) : feature.title,
              description: language === 'vi' ? (feature.description_vi || feature.description) : feature.description,
              image: feature.image
            }))}
            title={language === 'vi' ? 'TÍNH NĂNG NỔI BẬT' : 'KEY FEATURES'}
            layout="rokid"
          />
        </motion.div>
      </div>
